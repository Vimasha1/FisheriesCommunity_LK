...
const { createTicket, getTicket, getTickets, updateTicket, deleteTicket, sendEmail,sendEmailToManager } = require('../Controllers/ticketController');
...
router.post('/notify', sendEmail);

router.post('/notifyManager',sendEmailToManager)
